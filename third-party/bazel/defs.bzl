...
_NORMAL_DEPENDENCIES = {
    "third-party": {
        _COMMON_CONDITION: {
            ...
            "syn": Label("@vendor__syn-2.0.58//:syn"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("@//third-party/bazel:BUILD.syn-2.0.58.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "vendor__syn-2.0.58", is_dev_dep = False),
    ]
