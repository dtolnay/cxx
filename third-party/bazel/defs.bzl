...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.cc-1.1.37.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third-party/bazel:BUILD.syn-2.0.87.bazel"),
    )
    ...
    return [
        struct(repo = "vendor__cc-1.1.37", is_dev_dep = False),
