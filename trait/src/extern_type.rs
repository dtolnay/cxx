...
// Impl ExternType for foreign types, since this can only be done here (in the crate where the trait
// is defined). ExternType impls for cxx-provided types is in the larger cxx crate.
impl_extern_type! {
    [Trivial]
    bool = "bool"
    u8 = "std::uint8_t"
